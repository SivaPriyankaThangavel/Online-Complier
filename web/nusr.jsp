...
function check()
{
	alert("hai");
     ...
     if(document.f1.mname.value=="")
     {
     alert("Please enter midddle name");
     }
     else
		...
		if(document.f1.y.value=="")
	{
     ...
     if(document.f1.c_password.value=="")
     {
...
<td><input type="password" name="c_password" size="32"></td>           
</tr>         
<tr>                
...
<tr>                
<td></td>                
<td><input type="button" value="submit" onclick="check()">       
</tr>        
</table>
</form>  
</body>
